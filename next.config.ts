...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      anciennePrestation("/menage-apres-travaux-meaux", "/nettoyage-fin-de-chantier-paris"),
      anciennePrestation("/menage-apres-travaux", "/nettoyage-fin-de-chantier-paris"),
      anciennePrestation("/nettoyage-fin-de-chantier", "/nettoyage-fin-de-chantier-paris"),
